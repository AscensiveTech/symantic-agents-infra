...
// AI Receptionist gets its own Terms & Conditions / Privacy Policy, separate
// from RapidProposal's - same placeholder-content disclaimer applies: not
// legal advice, replace before relying on it in production.
export const DEFAULT_RECEPTIONIST_LEGAL_DOCUMENTS = {
  TERMS_AND_CONDITIONS: {
    version: "v1.0",
    title: "AI Receptionist - Terms & Conditions",
    effectiveFrom: "2026-09-01",
    content: [
      "Effective date: September 1, 2026",
      "Provided by: AscensiveTech (the \"Company\", \"we\", \"us\"). AI Receptionist is a product of AscensiveTech and is hosted on infrastructure operated by AscensiveTech's technology partner, Symantic.ai.",
      "Governing law: United States, State of Maryland",
      "",
      "1. Acceptance",
      "By creating an account or using AI Receptionist, you agree to these Terms on behalf of yourself and, if applicable, your Organization. You must actively accept these Terms before using the app, and you will be asked to re-accept whenever we make a material change.",
      "",
      "2. The Service",
      "AI Receptionist answers phone calls on your behalf using an AI voice agent, with call routing, knowledge-base answers, call summaries, and analytics. We may add, change, or remove features at any time, at our sole discretion, without liability to you.",
      "",
      "3. Accounts & Organizations",
      "Accounts are organization-based, with an Org Admin and additional General Access users. A Super Administrator (AI Receptionist's operator) sets each Organization's plan, pricing, and limits. Accounts cannot be deleted by users themselves - all deletion or offboarding requests go through your Org Admin or the operator. You are responsible for all activity under your account and for keeping credentials secure.",
      "",
      "4. Your Content",
      "You own the business information, knowledge-base content, and call data associated with your account (\"Customer Content\") and are solely responsible for its accuracy, legality, and appropriateness. You grant us a limited license to store and process Customer Content solely to provide the service, including transmitting call audio and transcripts to our voice-AI and telephony subprocessors.",
      "",
      "5. Plans, Minutes & Billing",
      "Plans include a monthly call-minute allowance, billed on a fixed day each month, with overage minutes billed at the applicable rate. Unused minutes do not carry over, and used minutes are non-refundable. Payments are recorded manually by the operator.",
      "",
      "6. Telephony & Voice AI Subprocessors",
      "The service relies on third-party telephony and voice-AI providers to place, receive, and process calls. Call audio, transcripts, and caller phone numbers are transmitted to these providers as part of delivering the service. You are solely responsible for complying with any call-recording notice or consent laws applicable to your business and jurisdiction.",
      "",
      "7. No Guarantee of Security, Backup, or Availability",
      "This is the core of how the service is provided, and you should read it carefully.",
      "Security: We use commercially reasonable tools and practices to help secure your data, but we do not guarantee that your data is or will remain secure. No system can be guaranteed against unauthorized access, breach, or loss.",
      "Backups: We perform backups on a best-effort basis only. We do not guarantee that any backup exists, is current, or is recoverable. You are solely responsible for maintaining your own copies of call recordings, transcripts, and any other data you consider important.",
      "Availability: The service is provided \"as is\" and \"as available\", including its ability to answer or place calls. We are not liable for downtime or unavailability caused by scheduled maintenance, our infrastructure or telephony providers, or any other cause, whether or not within our control.",
      "Bottom line: the fact that your data or the app is available today is not a promise that it will remain available tomorrow, and a missed call carries real business consequences. You use AI Receptionist, and rely on it to answer calls, entirely at your own risk.",
      "",
      "8. Disclaimer of Warranties",
      "Except as expressly stated in these Terms, AI Receptionist is provided without warranties of any kind, express or implied, including any implied warranties of merchantability, fitness for a particular purpose, or non-infringement.",
      "",
      "9. Limitation of Liability",
      "To the maximum extent permitted by law, our total liability to you for any claim of any kind arising from or related to AI Receptionist - including but not limited to data loss, security incidents, backup failures, missed or mishandled calls, or service unavailability - is limited to the fees you paid for the specific billing month in which the claim arose, and no more. In no event are we liable for indirect, incidental, special, consequential, or punitive damages, even if advised of the possibility of such damages.",
      "Some liability (for example, arising from gross negligence, willful misconduct, or fraud, or certain rights that cannot be waived under applicable law) cannot legally be limited by contract even with language like the above. This section limits our liability to the fullest extent the law allows, but does not claim to override protections that cannot be waived.",
      "",
      "10. Indemnification",
      "You agree to defend, indemnify, and hold us harmless from any claims, damages, or expenses (including reasonable attorney's fees) arising from your Customer Content, your use of the service, or your violation of these Terms, including claims brought by your own callers or customers.",
      "",
      "11. Force Majeure",
      "We are not liable for any failure or delay caused by events beyond our reasonable control, including natural disasters, internet, cloud, or telephony-network outages, acts of government, or other similar events.",
      "",
      "12. Suspension & Termination",
      "We may suspend or terminate your access for violating these Terms, misuse of the service, or non-payment, without liability to you beyond any applicable refund described in Section 9.",
      "",
      "13. Dispute Resolution - Arbitration & Class Action Waiver",
      "Any dispute arising from these Terms or your use of AI Receptionist will be resolved through individual, binding arbitration rather than in court, except where prohibited by law. You waive any right to bring or participate in a class, collective, or representative action against us. Arbitration will be conducted under the rules of a mutually agreed arbitration body, seated in Maryland.",
      "",
      "14. Governing Law",
      "These Terms are governed by the laws of the State of Maryland, USA, without regard to conflict-of-law principles.",
      "",
      "15. Intellectual Property",
      "AI Receptionist, including its software and design, is owned by AscensiveTech. It runs on infrastructure operated by AscensiveTech's technology partner, Symantic.ai, which does not thereby acquire any ownership of AI Receptionist. Nothing in these Terms transfers any ownership of AI Receptionist to you.",
      "",
      "16. General Terms",
      "These Terms are the entire agreement between you and us regarding AI Receptionist. If any provision is found unenforceable, the remaining provisions stay in effect. Our failure to enforce a provision is not a waiver of it. You may not assign these Terms without our consent; we may assign them freely.",
      "",
      "17. Changes to These Terms",
      "We may update these Terms at any time. Material changes require your re-acceptance before continued use.",
      "",
  ...
  PRIVACY_POLICY: {
    version: "v1.0",
    title: "AI Receptionist - Privacy Policy",
    effectiveFrom: "2026-09-01",
    content: [
      "Effective date: September 1, 2026",
      "Provided by: AscensiveTech (\"Company\", \"we\", \"us\"). AI Receptionist is a product of AscensiveTech, hosted on infrastructure operated by our technology partner, Symantic.ai.",
      "",
      "This Privacy Policy is informational. You can read and download it at any time, but unlike our Terms & Conditions, you are not asked to separately accept or reject it.",
      "",
      "1. What We Collect",
      "Account information: name, email, company, and role.",
      "Business configuration: business hours, knowledge-base content, call-handling settings, and all other content you create or upload in the app.",
      "Call data: caller phone numbers, call audio recordings, transcripts, and AI-generated summaries for every call your receptionist handles.",
      "Policy-acceptance records: timestamp, IP address, and browser user-agent, recorded whenever you accept our Terms & Conditions.",
      "Basic technical and usage data needed to operate, troubleshoot, and improve the service.",
      "",
      "2. How We Use It",
      "We use this data to provide and operate AI Receptionist, answer and route calls, generate call summaries and analytics, manage accounts, minutes, and billing, maintain compliance records, and provide customer support.",
      "",
      "3. Who We Share Data With",
      "Telephony and voice-AI providers - subprocessors that receive call audio, transcripts, and caller phone numbers in order to place, receive, and process calls on your behalf.",
      "Cloud service providers (such as AWS, Azure, etc.) - our infrastructure providers, hosting our files, application data, hosting environment, and authentication system.",
      "We may share data with service providers who help us operate AI Receptionist, under confidentiality obligations.",
      "",
      "4. Storage & Security",
      "Data is stored with cloud service providers such as AWS, Azure, etc., in the US East region. We use commercially reasonable measures to help protect your data, but as described in our Terms & Conditions, we do not guarantee the security or continued availability of any data stored in AI Receptionist.",
      "",
      "5. Data Retention",
      "We retain your data for as long as your account remains active. Once an account is no longer active, we do not guarantee any particular retention outcome - your data may be retained indefinitely or deleted at any time thereafter, at our discretion. Policy-acceptance and audit records may be retained beyond account activity for our own compliance and recordkeeping purposes.",
      "",
      "6. Your Rights & Account Deletion",
      "Because AI Receptionist accounts are organization-based, individual users cannot delete their own accounts or data directly. If you would like to access, correct, or request deletion of your information, please contact your Organization's Admin, or reach us directly at info@ascensivetech.com and we will coordinate with your Organization.",
      "",
      "7. Cookies & Local Storage",
      "We use cookies and/or local storage for essential functions such as keeping you logged in and remembering app preferences.",
      "",
      "8. Children's Privacy",
      "AI Receptionist is a business tool intended for use by adults and organizations. It is not directed at children, and we do not knowingly collect personal data from children.",
      "",
      "9. Changes to This Policy",
      "We may update this Privacy Policy from time to time. The current version will always be available in the app.",
      "",
...
export function defaultLegalDocument(documentType, product) {
  return product === "receptionist"
    ? DEFAULT_RECEPTIONIST_LEGAL_DOCUMENTS[documentType]
    : DEFAULT_LEGAL_DOCUMENTS[documentType];
}
